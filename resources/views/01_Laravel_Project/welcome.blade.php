...
<div class="w-200">
    <h1 class="text-2xl text-green-900 font-bold text-center my-5">Top Category</h1>
    <ul class="border border-gray-200">
         <li class="p-1 font-bold">
            <ul class="flex justify-between">
                <li class="w-30">S. No</li>
                <li class="w-100">Name</li>
                <li class="w-40">Quiz Count</li>
 ...
 <div class="w-200">
    <h1 class="text-2xl text-green-900 font-bold text-center my-10">Top Quiz</h1>
