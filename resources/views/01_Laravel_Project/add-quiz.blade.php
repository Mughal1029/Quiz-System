    ...
    <div class="bg-gray-100 flex flex-col items-center min-h-screen pt-5">
        <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
            ...
            <form action="add-quiz" method="get" class="space-y-4">
                ...
                <div>
                    <select type="text" name="category_id" id="" class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:outline-none">
            ...
            <form action="{{url('add-mcq')}}" method="post" class="space-y-4">
                <div>
                    @csrf
                    <textarea type="text" name="question" placeholder="Enter your question name" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none"></textarea>
                    @error('question')
                ...
                <a class="w-full bg-red-500 block text-center rounded-xl px-4 py-2 " href="end-quiz">Finish Quiz</a>
            </form>
            @endif
        </div>
    </div>
