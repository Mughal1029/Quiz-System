...
<body class="pt-10 text-center">
    <div class="flex justify-between w-200 ml-10">
         <button class="bg-blue-500 rounded-md px-4 py-2 my-5 text-white"><a href="/us">Back</a></button>
         <button class="bg-blue-500 rounded-md px-4 py-2 my-5 text-white"><a href="/download-certificate">Download</a></button>
